      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-24">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="relative mb-12">
            ...
            <div className="relative bg-white/25 backdrop-blur-lg rounded-3xl p-8 border border-white/40 shadow-xl">
              <div className="text-center space-y-6">
                ...
                <div className="bg-white/30 backdrop-blur-lg rounded-2xl p-6 mb-6 border border-white/40 shadow-xl">
